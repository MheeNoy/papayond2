...
const ReservationInformation = () => {
  ...
  const fetchSelectedSets = async booking_no => {
    try {
      console.log('Starting fetchSelectedSets with booking_no:', booking_no)
  ...
  useEffect(() => {
    console.log('useEffect for fetchSelectedSets and fetchGroupData is called')

    const fetchSelectedSetsInitial = async () => {
      try {
        console.log('Starting fetchSelectedSetsInitial')
